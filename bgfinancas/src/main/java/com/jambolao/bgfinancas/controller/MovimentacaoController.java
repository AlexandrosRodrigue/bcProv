...
public class MovimentacaoController {
    ...
    @GetMapping("/user/{userId}/categoria/{categoriaId}")
    public ResponseEntity<List<Movimentacao>> listByUserIdAndCategoriaId(
        @PathVariable Long userId, 
        @PathVariable Long categoriaId) {
    List<Movimentacao> movimentacoes = service.listByCategoriaIdAndUserId(categoriaId, userId);
